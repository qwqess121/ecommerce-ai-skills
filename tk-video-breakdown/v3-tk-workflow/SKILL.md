...
区块1: 竞品大盘总览（★转置矩阵表：指标竖排 · 达人横排）
  ...
  │   视频发布时间     │ video_detail_analysis                 │ publish_time（格式：MM-DD）
...
| 发布时间 | ✅ | ✅ | video_detail_analysis → published_at_ts |
...
> **区块01 的解读卡固定为2张**：关键发现（粉丝效率倒挂）+ 观看深度解读。不要再加第三张。
